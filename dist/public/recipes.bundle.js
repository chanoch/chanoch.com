...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function (test, buggy, set) {
      try {
        set = __webpack_require__(21)(Function.call, __webpack_require__(67).f(Object.prototype, '__proto__').set, 2);
        set(test, []);
...
var _Signature = __webpack_require__(147);

var _Signature2 = _interopRequireDefault(_Signature);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = _Signature2.default;
...
var _Navigation = __webpack_require__(158);
...
// module
exports.push([module.i, "/** layout.css */\n.section\n{\n    padding: 1rem 0;\n}\n@media (max-width: 991px)\n{\n    .section\n    {\n        padding: 3rem 0;\n    }\n}\n\nsection\n{\n    display: block;\n}\n\n.justify-content-between\n{\n    -webkit-box-pack: justify !important;\n    justify-content: space-between !important;\n}\n", ""]);
...
module.exports = {"twitterLink":"https://twitter.com/chanochwiggers","twitterLinkText":"Chanoch's twitter feed","linkedinLink":"https://linkedin.com/chanoch","linkedinLinkText":"Chanoch's Linked In profile","rights":"© 2018 chanoch.com. All rights reserved.","email":"email@chanoch.com","title":"chanoch.com","strapline":"Software Delivery","headerLinkText":"Linked In","menuItems":[{"key":"home","link":"/index.html","linkText":"Home"},{"key":"recipes","link":"/recipes/","linkText":"Recipes"}]}
...
var _Signature = __webpack_require__(146);

var _Signature2 = _interopRequireDefault(_Signature);

var _Recipe = __webpack_require__(222);
...
exports.default = function (props) {
    ...
    return _react2.default.createElement(
        _Layout2.default,
        { title: 'Wiggers family recipes.', config: _config2.default, active: "Recipes" },
        _react2.default.createElement(
            'div',
            { className: 'col-12' },
            _react2.default.createElement(
            ...
            selected.map(function (recipe) {
                return _react2.default.createElement(_Recipe2.default, { key: recipe.key, name: recipe.name });
            }),
            _react2.default.createElement(_Divider2.default, null),
            _react2.default.createElement(
                'h1',
...
var Recipe = function (_Component) {
    ...
    (0, _createClass3.default)(Recipe, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                "section",
                { className: "section section_blog-item" },
                _react2.default.createElement(
                    "div",
                    { className: "container" },
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                "div",
                                { className: "section_blog-item_body" },
                                _react2.default.createElement(
                                    "h3",
                                    { className: "section_blog-item_body__title text-center mb-0" },
                                    name
                                )
                            )
                        )
...
var routes = [{ path: '/recipes/', action: function action() {
        return _react2.default.createElement(_index2.default, null);
    } }, { path: '/recipes/index.html', action: function action() {
        return _react2.default.createElement(_index2.default, null);
    } }];
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_prop_types__ = __webpack_require__(228);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__compose__ = __webpack_require__(236);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__utils_warning__ = __webpack_require__(235);
...
var _rootReducer = __webpack_require__(268);

var _rootReducer2 = _interopRequireDefault(_rootReducer);

var _RecipesPage = __webpack_require__(221);

var _RecipesPage2 = _interopRequireDefault(_RecipesPage);

var _actions = __webpack_require__(267);

var _recipes = __webpack_require__(224);

var _recipes2 = _interopRequireDefault(_recipes);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var store = (0, _redux.createStore)(_rootReducer2.default, { recipes: _recipes2.default, selected: [] });

var mapStateToRecipePageProps = function mapStateToRecipePageProps(state) {
...
var mapDispatchToRecipePageProps = function mapDispatchToRecipePageProps(dispatch) {
    return {
        select: function select(id) {
            return dispatch((0, _actions.selectRecipe)(id));
        },
        deselect: function deselect(id) {
            return dispatch((0, _actions.deselectRecipe)(id));
        }
    };
};

var ConnectedRecipesPage = (0, _reactRedux.connect)(mapStateToRecipePageProps, mapDispatchToRecipePageProps)(_RecipesPage2.default);

var MenuApp = function (_React$Component) {
    (0, _inherits3.default)(MenuApp, _React$Component);

    function MenuApp() {
        (0, _classCallCheck3.default)(this, MenuApp);
        return (0, _possibleConstructorReturn3.default)(this, (MenuApp.__proto__ || (0, _getPrototypeOf2.default)(MenuApp)).apply(this, arguments));
    }

    (0, _createClass3.default)(MenuApp, [{
        key: 'render',
        value: function render() {
            return _react2.default.createElement(
                _reactRedux.Provider,
                { store: store },
                _react2.default.createElement(ConnectedRecipesPage, null)
            );
        }
    }]);
    return MenuApp;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_prop_types__ = __webpack_require__(228);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_redux__ = __webpack_require__(231);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__wrapMapToProps__ = __webpack_require__(237);
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(234), __webpack_require__(258)(module)))
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utils_warning__ = __webpack_require__(235);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__compose__ = __webpack_require__(236);
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__wrapMapToProps__ = __webpack_require__(237);
...
exports.selectRecipe = function (id) {
    type: 'SELECT_RECIPE', id;
};

exports.deselectRecipe = function (id) {
    type: 'DESELECT_RECIPE', id;
};

exports.useRecipe = function (id) {
    type: 'USE_RECIPE', id;
};
...
var selectRecipeReducer = function selectRecipeReducer(state, action) {
    var selectedRecipe = state.recipes.find(function (recipe) {
...
var deselectRecipeReducer = function deselectRecipeReducer(state, action) {
    var deselectedRecipe = state.selected.find(function (recipe) {
        return recipe.id === action.id;
    });
    return {
        recipes: state.selected.slice(0).push(deselectedRecipe),
        selected: state.recipes.filter(function (recipe) {
            return action.id !== recipe.id;
        })
    };
};
...
var rootReducer = function rootReducer(state, action) {
    switch (action.type) {
        case _actions.selectRecipe.type:
            selectRecipeReducer;
        case _actions.deselectRecipe.type:
            deselectRecipeReducer;
        default:
            return state;
    }
};

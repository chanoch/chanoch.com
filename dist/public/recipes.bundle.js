...
var _recipes = __webpack_require__(219);
...
function render(location) {
    _Router2.default.resolve(_recipes2.default, location).then(renderComponent).catch(function (error) {
        return _Router2.default.resolve(_recipes2.default, { location: location, error: error }).then(renderComponent);
    });
}
...
var _RecipesPage = __webpack_require__(220);
...
var routes = [{ path: '/recipes/', action: function action() {
        return _react2.default.createElement(_RecipesPage2.default, null);
...
var _Recipe = __webpack_require__(221);
...
var _recipes = __webpack_require__(223);
...
var RecipesPage = function (_Component) {
    (0, _inherits3.default)(RecipesPage, _Component);
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(_Divider2.default, null),
                    _recipes2.default.map(function (recipe) {
